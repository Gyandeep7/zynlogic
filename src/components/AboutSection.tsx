...
const AboutSection = () => {
  const benefits = ["Industry-leading expertise", "Dedicated development teams", "Modern technology stack", "Agile development process", "Transparent communication", "Long-term partnership"];
  return <section id="about" className="section-padding bg-gray-50">
      <div className="container-custom grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&q=80" alt="Our Team" className="rounded-lg shadow-xl max-w-full h-auto" />
        </div>
        ...
        <div className="space-y-6 order-1 md:order-2">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-purple-700">We offer software services for businesses</h2>
